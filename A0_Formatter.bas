Attribute VB_Name = "A0_Formatter"
Option Explicit
...
Private words As Scripting.Dictionary 'Keys are Strings, Value is an Integer indicating change in indentation
...
Private Sub initializeWords()
    ...
    Dim w As New Scripting.Dictionary
    w.Add BEG_SUB, 1
    w.Add END_SUB, -1
    w.Add BEG_PB_SUB, 1
    w.Add BEG_PV_SUB, 1
